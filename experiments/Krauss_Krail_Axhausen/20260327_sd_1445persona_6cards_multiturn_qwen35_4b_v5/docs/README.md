# Krauss_Krail_Axhausen 短距离逐题版 AI 复现实验（v5 全量运行）

## 实验定位

这个实验目录是基于 `20260327_sd_1445persona_6cards_multiturn_qwen35_4b_v4` 的正式全量运行版。
...
```powershell
python experiments\Krauss_Krail_Axhausen\20260327_sd_1445persona_6cards_multiturn_qwen35_4b_v5\scripts\run_ai_collection.py
```

小样本验证：

```powershell
python experiments\Krauss_Krail_Axhausen\20260327_sd_1445persona_6cards_multiturn_qwen35_4b_v5\scripts\run_ai_collection.py --n-respondents 3
```

断点续跑：

```powershell
python experiments\Krauss_Krail_Axhausen\20260327_sd_1445persona_6cards_multiturn_qwen35_4b_v5\scripts\run_ai_collection.py --resume
```

### 估计与汇总

```powershell
python experiments\Krauss_Krail_Axhausen\20260327_sd_1445persona_6cards_multiturn_qwen35_4b_v5\scripts\estimate_mixed_choice_model.py
python experiments\Krauss_Krail_Axhausen\20260327_sd_1445persona_6cards_multiturn_qwen35_4b_v5\scripts\build_comparison.py
python experiments\Krauss_Krail_Axhausen\20260327_sd_1445persona_6cards_multiturn_qwen35_4b_v5\scripts\summarize_experiment.py
```
