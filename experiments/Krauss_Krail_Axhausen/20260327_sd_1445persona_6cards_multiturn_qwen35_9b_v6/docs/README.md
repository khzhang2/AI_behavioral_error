# Krauss_Krail_Axhausen 短距离逐题版 AI 复现实验（v6 9b 全量运行）

## 实验定位

这个实验目录是基于 `20260327_sd_1445persona_6cards_multiturn_qwen35_4b_v5` 的同设定换模型版本。

目标不是改动 v3 的样本规模或 mixed logit 规格，而是修正最关键的 survey 呈现偏差：

- 保留 `1445` 个 persona
- 保留 `6` 张 short-distance 重建题卡
- 改用本地 `qwen3.5:9b`，其余 decoding 设定保持不变
...
```powershell
python experiments\Krauss_Krail_Axhausen\20260327_sd_1445persona_6cards_multiturn_qwen35_9b_v6\scripts\run_ai_collection.py
```

小样本验证：

```powershell
python experiments\Krauss_Krail_Axhausen\20260327_sd_1445persona_6cards_multiturn_qwen35_9b_v6\scripts\run_ai_collection.py --n-respondents 3
```

断点续跑：

```powershell
python experiments\Krauss_Krail_Axhausen\20260327_sd_1445persona_6cards_multiturn_qwen35_9b_v6\scripts\run_ai_collection.py --resume
```

### 估计与汇总

```powershell
python experiments\Krauss_Krail_Axhausen\20260327_sd_1445persona_6cards_multiturn_qwen35_9b_v6\scripts\estimate_mixed_choice_model.py
python experiments\Krauss_Krail_Axhausen\20260327_sd_1445persona_6cards_multiturn_qwen35_9b_v6\scripts\build_comparison.py
python experiments\Krauss_Krail_Axhausen\20260327_sd_1445persona_6cards_multiturn_qwen35_9b_v6\scripts\summarize_experiment.py
```
