# 20260417_optima_intervention_regime_gemma4_31b_awq_v1 Atasoy 2011 analysis
...
| --- | ---: | ---: |
| log-likelihood | -1067.356 | -803.484 |
| PMM VOT (CHF/hour) | 30.35 | 4.66 |
| PT VOT (CHF/hour) | 12.24 | 11.72 |
| PMM share | 0.6231 | 0.9192 |
| PT share | 0.3209 | 0.0650 |
| SM share | 0.0560 | 0.0158 |
...
| --- | ---: | ---: |
| choice-only log-likelihood | -1067.432 | -905.769 |
| PMM VOT (CHF/hour) | 31.56 | 1.63 |
| PT VOT (CHF/hour) | 12.77 | 10.31 |
| mean Acar | 2.886 | 2.869 |
| mean Aenv | 3.547 | 3.645 |
